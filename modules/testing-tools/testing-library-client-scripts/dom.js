...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.TestingLibraryDom = {}));
  ...
  */
  ...
  var AsymmetricMatcher = createCommonjsModule(function (module, exports) {
    ...
    var _Symbol = commonjsGlobal['jest-symbol-do-not-touch'] || commonjsGlobal.Symbol;
  ...
  var markup = createCommonjsModule(function (module, exports) {
    ...
    (escapeHTML_1); // Return empty string if children is empty.
    ...
    exports.printText = printText; // Separate the functions to format props, children, and element,
  ...
  var ReactTestComponent = createCommonjsModule(function (module, exports) {
    ...
    var _Symbol2 = commonjsGlobal['jest-symbol-do-not-touch'] || commonjsGlobal.Symbol;

    var testSymbol = _Symbol2.for('react.test.json');
  ...
  var build = createCommonjsModule(function (module) {
    ...
    var _Symbol3 = commonjsGlobal['jest-symbol-do-not-touch'] || commonjsGlobal.Symbol;

    var toString = Object.prototype.toString;
    var toISOString = Date.prototype.toISOString;
    var errorToString = Error.prototype.toString;
    var regExpToString = RegExp.prototype.toString;
    var symbolToString = _Symbol3.prototype.toString;
    /**
    ...
    function printPlugin(plugin, val, config, indentation, depth, refs) {
      ...
      if (typeof printed !== 'string') {
        throw new Error("pretty-format: Plugin must return type \"string\" but instead returned \"" + _typeof(printed) + "\".");
      }
  ...
  */
  ...
  var getMultipleError$1 = function getMultipleError$1(c, text) {
  ...
  var getMultipleError$2 = function getMultipleError$2(c, text) {
    return "Found multiple elements with the placeholder text of: " + text;
  };

  var getMissingError$1 = function getMissingError$1(c, text) {
  ...
  var getMultipleError$3 = function getMultipleError$3(c, value) {
    return "Found multiple elements with the value: " + value + ".";
  };

  var getMissingError$2 = function getMissingError$2(c, value) {
  ...
  var getMultipleError$4 = function getMultipleError$4(c, alt) {
    return "Found multiple elements with the alt text: " + alt;
  };

  var getMissingError$3 = function getMissingError$3(c, alt) {
  ...
  var getMultipleError$5 = function getMultipleError$5(c, title) {
    return "Found multiple elements with the title: " + title + ".";
  };

  var getMissingError$4 = function getMissingError$4(c, title) {
  ...
  var getMultipleError$6 = function getMultipleError$6(c, role) {
    return "Found multiple elements with the role \"" + role + "\"";
  };

  var getMissingError$5 = function getMissingError$5(container, role, _temp2) {
    var _ref2 = _temp2 === void 0 ? {} : _temp2,
  ...
  var getMultipleError$7 = function getMultipleError$7(c, id) {
    return "Found multiple elements by: [" + getTestIdAttribute() + "=\"" + id + "\"]";
  };

  var getMissingError$6 = function getMissingError$6(c, id) {
